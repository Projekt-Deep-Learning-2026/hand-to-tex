...
import wandb
from hand_to_tex.models.components.experimental_kvcache import (
...
class HMELightningModule(pl.LightningModule):
    ...
    def generate(self, src: Tensor, src_lengths: Tensor) -> Tensor:
        ...
        kv_cache = self.model.init_kv_cache(memory)
        ...
        for step in range(1, self.max_generate_len):
            ...
            next_token_logits, kv_cache = self.model.decode_step(
                tgt_last=last_token,
                memory=memory,
